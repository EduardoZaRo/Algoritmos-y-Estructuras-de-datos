...
def busqueda_interpolada_recursiva(arreglo, li, ls, iteraciones, valor_buscado):
    ...
    iteraciones+=1
    if(li > ls or interpolado < li or interpolado > ls): #Sin (interpolado <= 0 and valor_buscado != arreglo[0]) la funcion puede ejecutarse infinitamente jaja q feo
...
arreglo=[3,6,9,12,15,18,21,24,27,30,33,36,39,41,45,48]
